	...
	<aside class="chef-aside">
		<nav>
			...
			<ul>
				...
				<li class="write-button"><a href="#"><img src="${ctx}/resources/images/pencil(1).jpg" /></a></li>
				<li class="timer-button"><a href="#"><img src="${ctx}/resources/images/timer.jpg" /></a></li>
			</ul>
		</nav>
		
		<div class="timer">
			예약시간 <input type="text" id="expireMin" style="width:30px;text-align:right">
			분 이후	
